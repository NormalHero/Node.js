...
function createSchema(app, config){
    ...
    for(let i=0; i<schemaLen; i++){
        ...
        */
        ...
        database[curItem.schemaName] = curSchema;   // database[MemberSchema] = MemberSchema객체
        database[curItem.modelName] = curModel;     // database[MemberModel] = MemberModel객체
        console.log(`스키마이름[${curItem.schemaName}], 모델이름[${curItem.modelName}]이 데이터베이스 객체의 속성으로 추가되었음`);
